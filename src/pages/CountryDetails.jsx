        ...
        <div className="w-3/4">
          <div className="overflow-hidden rounded-t-xl">
            <img
              src={image_url}
              alt="No image"
              className="mx-auto h-42 md:h-[320px] w-full object-cover transition duration-700 hover:skew-x-2 hover:scale-110 rounded-t-xl"
            />
          </div>

          <div className="shadow-2xl rounded-b-3xl mb-4 p-4">
            <h1 className="my-2 border-l-8 border-red-500 py-2 pl-2 text-2xl font-bold">
              {spot_name}
              <span
                className="ml-2"
